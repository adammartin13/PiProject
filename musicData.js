var musicData = [{"name":"08 All Your'n.mp3"},{"name":"test.mp3","cover":"./images/albumArt/test.png"},{"name":"test2.mp3","cover":"./images/albumArt/test2.png"}];
...
function updateTable(){
	...
	for (var it = 0; it < musicData.length; it++){ 
		songList += "<tr><td class=\"song\"><button onclick=\"songClick(" + it + ")\">" + musicData[it].name + "</button></td><td>X</td><td>X</td><td>X</td></tr>";
